    ...
    <div className='md:w-[400px] md:h-[270px] w-[350px] h-[240px] fixed z-10 right-8 mt-4 bg-black text-white'>
        <div className='flex flex-col m-4'>
            ...
            <div className='flex justify-center items-center'>
                <img src={figures.image} className="w-[110px] h-[110px] object-cover object-top mr-[12px]"/>
            ...
            <Link to="/checkout">
            <button className='md:px-12 md:py-4 px-8 py-2 bg-red-500 rounded-full text-lg font-bold hover:bg-black border-2 border-red-500 hover:border-white duration-300'>View Cart</button>
            </Link>
            </div>
        </div>
    </div>
