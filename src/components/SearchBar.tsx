...
export default function SearchBar() {
  ...
  return (
    <div>
      <div className="relative xl:w-[800px] md:w-[400px] w-[190px] h-10 text-white md:mr-16 mr-1">
